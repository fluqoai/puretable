...
export const Route = createFileRoute("/c/$slug")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Browse gluten-free places in Saudi Arabia by category on Pure Table.",
      },
...
function CustomFilterPage() {
  ...
  const entry = all.find((category) => category.slug === slug);
  const value = entry?.value ?? `cf_${slug}`;
